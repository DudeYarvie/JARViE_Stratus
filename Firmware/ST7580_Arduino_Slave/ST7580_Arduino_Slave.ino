...
/*
*ST7580_RX_data
*Purpose: Receives DL_Datadata sent across the powerline 
*
*/
void ST7580_RX_data()
{
  ...
  if ((rx_checksum & 0xFF) == rx_buf[rx_data_byte_length - 2]){   //only confirming LSB of received 2 byte checksum.  This condition IS checking properly. 10-APR-2023
